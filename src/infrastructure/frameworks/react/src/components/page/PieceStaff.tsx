        ...
        <div className="p-6">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Button
                        onClick={() => navigate('/create/pieces')}
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="hover:bg-transparent">
                                    ...
                                    <th className="font-medium">Prix</th>
                                    <th className="font-medium">Quantité</th>
                                    <th className="font-medium">Limite d'alerte</th>
